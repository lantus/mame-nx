...
$(OBJ)/other.a: \
	...
	$(OBJ)/drivers/dietgo.o \
	$(OBJ)/drivers/boogwing.o \
	$(OBJ)/drivers/pktgaldx.o \
	$(OBJ)/drivers/simpl156.o \
	$(OBJ)/vidhrdw/fuukifg3.o $(OBJ)/drivers/fuukifg3.o \
	$(OBJ)/vidhrdw/denjinmk.o $(OBJ)/drivers/denjinmk.o \
	$(OBJ)/drivers/dreamwld.o \
	$(OBJ)/machine/nmk004.o $(OBJ)/machine/seicop.o $(OBJ)/sndhrdw/seibu.o 
